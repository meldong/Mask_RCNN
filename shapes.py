...
COCO_MODEL_PATH = os.path.join(ROOT_DIR, "_init_/mask_rcnn_coco.h5")
...
print(">> Load and display random samples...")
...
print(">> Loading weights trained on MS COCO...")
...
print(">> Compute VOC-Style mAP @ IoU=0.5...")
